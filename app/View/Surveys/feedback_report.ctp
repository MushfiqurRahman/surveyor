                            ...
                            <div class="portlet-body">
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['is_right_name']==1 ? 'Right' : 'Wrong';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Survey']['phone'];?></td>
                                        <td class="center hidden-phone"><?php echo $fb['Feedback']['is_right_age']==1 ? 'Right' : 'Wrong';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['is_right_occupation']==1 ? 'Right' : 'Wrong';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['current_brand'];?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['new_pack']==1 ? 'Yes' : 'No';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['tobacco_quality']==1 ? 'Yes' : 'No';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['br_toolkit']==1 ? 'Yes' : 'No';?></td>
                                        <td class="hidden-phone"><?php echo $fb['Feedback']['got_ptr']==1 ? 'Yes' : 'No';?></td>
